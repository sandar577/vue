...
const emit = defineEmits<{
  (e: 'onConfirm', value: boolean): void
}>()
</script>
<template>
  <div>
          ...
          >
            ...
            >
              ...
              >
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                  <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      ...
                      <div class="mt-2">
                        <p class="text-sm">
                          Are you sure you want to {{ props.action }}? This action cannot be undone.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div
                  class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6 sm:justify-center mb-4"
                >
                  <CommonButton
                    :class="'mx-2'"
                    :btnType="Type.danger"
                    ...
                    >{{ props.actionBtnLabel }}</CommonButton
                  >
                  <CommonButton
                    :btnType="Type.light"
                    :size="Size.sm"
